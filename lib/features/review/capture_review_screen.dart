        ...
        children: [
          FutureBuilder<Map<String, dynamic>>(
            ...
            builder: (context, snapshot) {
              ...
              final faceLum =
                  double.tryParse(data['Face_Luminance'] ?? '0') ?? 0.0;
              final dofRatio =
                  double.tryParse(data['Aperture_Depth_Ratio'] ?? '0') ?? 0.0;
              final dynRange =
                  double.tryParse(data['Dynamic_Range_Width'] ?? '0') ?? 0.0;
              final colTemp =
                  double.tryParse(data['Color_Temp_Index'] ?? '128') ?? 128.0;
                      ...
                      child: GridView.count(
                        ...
                        children: [
                            ...
                            status: faceLum < ProThresholds.severeUnderExposed
                                ...
                                : faceLum < ProThresholds.slightlyDark
                                    ...
                                    : faceLum > ProThresholds.highlightClipping
                                        ? 'Over-exposed'
                                        : 'Balanced',
                            statusColor: faceLum < ProThresholds.slightlyDark ||
                                    faceLum > ProThresholds.highlightClipping
                                ? (faceLum < ProThresholds.severeUnderExposed ||
                                        faceLum >
                                            ProThresholds.highlightClipping
                                    ? AppTheme.errorColor
                                    : AppTheme.warningColor)
                                : AppTheme.successColor,
                          ...
                          MetricCard(
                            ...
                            status: dynRange > ProThresholds.excellentHdr
                                ? 'High'
                                : 'Normal',
                            statusColor: dynRange > ProThresholds.excellentHdr
                                ? AppTheme.successColor
                                : AppTheme.textSecondary,
                          ...
                          MetricCard(
                            ...
                            status: colTemp > ProThresholds.warmLimit
                                ...
                                : colTemp < ProThresholds.coolLimit
                                    ? 'Cool / Blue'
                                    : 'Neutral',
                            statusColor: colTemp > ProThresholds.warmLimit ||
                                    colTemp < ProThresholds.coolLimit
                                ? AppTheme.warningColor
                                : AppTheme.successColor,
                    ...
                    Padding(
                      ...
                      child: Column(
                        children: feedbackList
                            .map((critique) => FeedbackCard(critique: critique))
                            .toList(),
                      ),
                    ),
                    Padding(
